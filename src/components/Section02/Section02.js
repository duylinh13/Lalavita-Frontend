...
const Section2 = () => {
  return (
    <div
      id="section2"
      className="h-[1090px] flex flex-col items-center justify-start bg-[#fed614] text-center pt-[240px] sm:pt-[120px] md:pt-[240px] overflow-hidden" // Thêm overflow-hidden ở đây
    >
      {/* Dòng chữ chính */}
      ...
      {/* Nội dung chính */}
      <h2 className="font-[PretendardVariable] text-[24px] md:text-[40px] font-[600] leading-[1.3] md:leading-[1.2] text-[#222] mb-0 w-[100%] md:w-[90%] lg:w-[900px] h-[auto] md:h-[58px] mt-[20px] md:mt-[31px]">
      ...
      <div className="three-items flex flex-row justify-center mt-20 w-full px-4 md:px-52 overflow-hidden gap-x-8">
        {/* Card 1 */}
        <div className="relative flex flex-col items-start justify-start p-4 rounded-[20px] shadow-lg bg-white w-[90%] sm:w-[60%] md:w-[30%] mx-0 mb-6 transition-transform duration-300 transform h-[400px] sm:h-[340px] md:h-[448px]">
          ...
          />
          <span className="text-[#222] font-[PretendardVariable] text-[28px] font-semibold leading-[1.25] text-start mb-6 ml-6 mr-[167px]">
            인체의 NAD+ 균형 유지를 위해
          </span>
          <span className="text-[#999] mx-6 font-[PretendardVariable] text-[14px] leading-[1.5] text-start">
        ...
        <div className="relative flex flex-col items-start justify-start p-4 rounded-[20px] shadow-lg bg-[#42c0cc] w-[90%] sm:w-[60%] md:w-[30%] mx-0 mb-6 transition-transform duration-300 transform h-[400px] sm:h-[340px] md:h-[448px]">
          <img
            ...
            className="w-[62px] h-[61px] object-contain mb-10 mt-6 ml-6"
          />
          <span className="text-[#222] font-[PretendardVariable] text-[28px] font-semibold leading-[1.25] text-start mb-6 ml-6 mr-[100px]">
            인체 내의 주요 세포 에너지원
          </span>
          <span className="text-black font-[PretendardVariable] text-[14px] leading-[1.5] text-start mx-6">
        ...
        <div className="relative flex flex-col items-start justify-start p-4 rounded-[20px] shadow-lg bg-white w-[90%] sm:w-[60%] md:w-[30%] mx-0 mb-6 transition-transform duration-300 transform h-[400px] sm:h-[340px] md:h-[448px]">
          <img
            ...
            className="w-[62px] h-[61px] object-contain mb-10 mt-6 ml-6"
          />
          <span className="text-[#222] font-[PretendardVariable] text-[28px] font-semibold leading-[1.25] text-start mb-6 mx-6">
            젊음 유지 및 노화 억제에 탁월한 효과
          </span>
          <span className="text-[#999] font-[PretendardVariable] text-[14px] leading-[1.5] text-start mx-6">
