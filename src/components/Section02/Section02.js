...
const Section2 = () => {
  return (
    ...
    >
      ...
      {/* Nội dung chính */}
      <h2 className="font-[PretendardVariable] text-[40px] font-[600] leading-[1.2] text-[#222] mb-0 w-[90%] md:w-[900px] h-[58px] mt-[31px]">
      ...
      <div className="three-items flex flex-col md:flex-row md:justify-between mt-24 w-full px-0 md:px-52 overflow-hidden">
        {" "}
        ...
        <div className="relative flex flex-col items-start justify-start h-auto p-[30px] rounded-[20px] shadow-lg bg-white w-full md:w-1/3 mx-2 mb-4 md:mb-10 transition-transform duration-300 transform ">
          ...
          />
          <span className="text-[#222] font-[PretendardVariable] text-[28px] font-semibold leading-[1.25] text-start mb-[30px]">
            인체의 NAD+ 균형 유지를 위해
          </span>
          <span className="text-[#999] font-[PretendardVariable] text-[16px] leading-[1.67] text-start">
            인체에서 에너지 생성, 대사 및 유전자 발현에 중요한 역할을 하는
            NAD+는 모든 살아 있는 세포에서 발견되는 보조인자입니다. 사람은
            나이가 들수록 가졌던 NAD+ 수준이 감소하여 노화 속도가 빨라지고 관련
            신체 건강 상태도 나빠지기도 합니다.
          </span>
        </div>
        {/* Card 2 */}
        <div className="relative flex flex-col items-start justify-start h-auto p-[30px] rounded-[20px] shadow-lg bg-[#42c0cc] w-full md:w-1/3 mx-2 mb-4 md:mb-10 transition-transform duration-300 transform ">
          ...
          <span className="text-black font-[PretendardVariable] text-[16px] leading-[1.67] text-start">
            인체에서 에너지 생성, 대사 및 유전자 발현에 중요한 역할을 하는
            NAD+는 모든 살아 있는 세포에서 발견되는 보조인자입니다. 사람은
            나이가 들수록 가졌던 NAD+ 수준이 감소하여 노화 속도가 빨라지고 관련
            신체 건강 상태도 나빠지기도 합니다.
